  ...
  <div class="modal fade" id="add_student" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body customer-box">
        <!-- Nav tabs -->
       <form role="form" class="form-horizontal" method= "POST" action="add_dept_exec.php">
              <div class="form-group">
                <div class="col-sm-12">
                  <input class="form-control" id="email1" placeholder="Enter department name" type="text" name="dname" required>
                </div>
              </div>
            ...
            <tr>
              <td width="1155"><div class="card">
                <div class="card-header">
                  ...
                  <button class="btn btn-primary" style="float:right;" data-toggle="modal" data-target="#add_student">Add new department</button>
...
{ ?>
                        ...
                        <td><span class="style6">
                         <a href="edit_depts.php?id=<?php echo $row['id'];?>" ><span class="btn-outline-info btn-sm" >Edit</span></a>
                         
                        
             <a href="departments.php?delete=<?php echo $row['id'];?>" onClick="return deldata('<?php echo $row['fullname']; ?>');"><span class="btn-outline-danger btn-sm" style=" margin-left: 7px;">delete</span></a>
                     </span></td>
                      </tr>
                      <?php $cnt=$cnt+1;} ?>
                    </tbody>
