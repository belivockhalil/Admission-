...
if (isset($_GET['delete'])) {
  ...
  $sql = "DELETE FROM programs WHERE id='".$_GET['delete']."'";
  $conn->query($sql);
   # code...
 } 
?>
   ...
   <?php if (!isset($_GET['update'])) { ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body customer-box">
        <!-- Nav tabs -->
       <form role="form" class="form-horizontal" method= "POST" action="add_program_exec.php">
              <div class="form-group">
                <div class="col-sm-12">
                  <input class="form-control" id="email1" placeholder="Enter program name" type="text" name="pname" required>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-12">
              ...
              <div class="form-group">
                <div class="col-sm-12">
                  <input class="form-control" id="exampleInputPassword1" placeholder="Enter clusters required" type="text" name="cluster_point" required>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-12">
                  <input class="form-control" id="exampleInputPassword1" placeholder="Enter number of students" type="text" name="no_of_students" required>
                </div>
              </div>
            ...
            <tr>
              <td width="1155"><div class="card">
                <div class="card-header">
                  <h2>Programs' Record</h2>
                  <h3 class="card-title">&nbsp;</h3>
                  <button class="btn btn-primary" style="float:right;" data-toggle="modal" data-target="#add_student">Add new program</button>
                ...
                <div class="card-body">
                  <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                    <thead>
                      <tr> <th width="3%">#</th>
                        <th width="13%">Program name</th>
                        <th width="7%">Departmant</th>
                        <th width="9%">Clusters</th>
                        <th width="9%">No of students</th>
             ...
             <td><div align="center"><?php echo $row['no_of_students']; ?></div></td>
...
<a href="edit_program.php?id=<?php echo $row['id'];?>" ><span class="btn-outline-info btn-sm" >Edit</span></a>
                         
                        
					   <a href="programs.php?delete=<?php echo $row['id'];?>" onClick="return deldata('<?php echo $row['fullname']; ?>');"><span class="btn-outline-danger btn-sm" style="margin-left: 7px;">delete</span></a>
