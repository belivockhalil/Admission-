...
$id=intval($_GET['id']);
  ...
  $update = "SELECT * FROM departments WHERE id= '$id'";
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Depts' Record</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="modal-content">
      <div class="modal-header tit-up">
        ...
        <h4 class="modal-title">Edit depts </h4>
      </div>
      <div class="modal-body customer-box">
       ...
       <form role="form" class="form-horizontal" method= "POST" action="">
        <div class="form-group">
                <div class="col-sm-12">
                  <input class="form-control" id="email1" placeholder="" type="hidden" name="id" value="<?php echo $id; ?>">
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-12">
                  <input class="form-control" id="email1" placeholder="Enter program name" type="text" name="name" value="<?php echo $name; ?>" required>
                </div>
              </div>
