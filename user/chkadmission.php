...
$sql1 = " update student set idnumber='$idnumber',photo='$location' where email='$email'";
...
<head>
    ...
    <title>Course Transfer Online Student Admission system</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Course transfer application</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
...
$row= mysqli_fetch_array($result);
                    ...
                    <div class="ibox-content">
                        <div class="row">
                                ...
                                <h3 class="m-t-none m-b">Fill the application</h3>
             <form  action="transfer.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-sm-12">
                <select class="form-control" value="" name="course_to" aria-label="Default select example">
 <option >Select Program</option>
                  ...
                  ?>
                                ...
                                <br>
                                 ...
                                 <div class="form-group">
                <div class="col-sm-12">
                  <textarea style="height: 200px;" class="form-control" id="email1" placeholder="Enter Reason" type="text" name="reason" value="" required></textarea> 
                </div>
              </div>
                                        ...
                                        <p>&nbsp;</p>
                                        <p>&nbsp;</p>
                                        <button class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit" name="btnsubmit">
                                        <div align="centre"><strong><i class="fa fa-paste"></i> Submit Application</strong></div>
                                        </button>
                                  </div>
                                </form>
                            </div>
