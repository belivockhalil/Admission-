...
$row= mysqli_fetch_array($result);
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-6 b-r"><h3 class="m-t-none m-b">Edit Profile</h3>
             <form  action="" method="POST" enctype="multipart/form-data">
                                    <div class="form-group"><strong>
                                    <label>Idnumber</label></strong>
                                    <input type="text" size="77" name="idnumber"  value="<?php echo $row['idnumber'];   ?>" class="form-control" required="">
                                    </div>
                                   <!--  <div class="form-group"><strong>
                                    <label>Email</label></strong>
                                    <input type="text" size="77" name="email"  value="<?php echo $row['email'];   ?>" class="form-control" required="">
                                    </div> -->
                                ...
                                <p class="text-center">
                                    <img src="../<?php echo $row['photo'];   ?>" alt="" width="166" height="147">                                </p>
                                <p class="text-center">
