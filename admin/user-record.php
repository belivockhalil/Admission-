  ...
  <div class="modal fade" id="add_student" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body customer-box">
        <!-- Nav tabs -->
       <form role="form" class="form-horizontal" method= "POST" action="add_exec.php">
              <div class="form-group">
                <div class="col-sm-12">
                  <label>FullName</label>
                  <input class="form-control" id="email1" placeholder="Enter fullname" type="text" name="fullname" required>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-12">
  ...
  <option value="female">female</option>
              ...
              <div class="form-group">
                <div class="col-sm-12">
                  ...
                  <input class="form-control" id="exampleInputPassword1" placeholder="Enter Registration no" type="text" name="regno" required>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-12">
                  <label>Id number</label>
                  <input class="form-control" id="exampleInputPassword1" placeholder="Enter Id number" type="text" name="idnumber" required>
                </div>
              </div>
               <div class="form-group">
                <div class="col-sm-12">
                  <label>Email</label>
                  <input class="form-control" id="exampleInputPassword1" placeholder="Enter Students email" type="text" name="email" required>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-sm-12">
                  ...
                  <input class="form-control" id="exampleInputPassword1" placeholder="Enter Date of birth" type="date" name="dob" required>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-12">
                  <label>cluster</label>
                  <input class="form-control" id="exampleInputPassword1" placeholder="Enter clusters" type="text" name="cluster_point" required>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-12">
 ...
 <option >Select Program</option>
              ...
              <div class="form-group">
                <div class="col-sm-12">
                  ...
                  <input class="form-control" id="exampleInputPassword1" placeholder="Enter Date of Admission" type="date" name="date_admission" required>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-10">
            ...
            <tr>
              <td width="1155"><div class="card">
                <div class="card-header">
                  ...
                  <button class="btn btn-primary" style="float:right;" data-toggle="modal" data-target="#add_student">Add new student</button>
                  ...
                  <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                    <thead>
                      <tr> <th width="3%">#</th>
                        ...
                        <th width="13%">Id No</th>
                        <th width="9%">Email</th>
                        <th width="7%">Dob</th>
                        <th width="7%">dept</th>
						 <th width="8%">program</th>
             <th width="9%">clusters</th>
              <th width="9%">date of admission</th>
                        <th width="8%">Photo</th>
                    ...
                    <tbody>
                							      <?php 
                                          $sql = "SELECT * FROM student order by date_admission ASC";
                                           $result = $conn->query($sql);
										$cnt=1;
                                           while($row = $result->fetch_assoc()) { 
										   ?>
					  ...
					  <td height="47"><div align="center"><?php echo $cnt; ?></div></td>
                        ...
                        <td><div align="center"><?php echo $row['program']; ?></div></td>
						 <td><div align="center"><?php echo $row['cluster_points']; ?></div></td>
             <td><div align="center"><?php echo $row['date_admission']; ?></div></td>
                        ...
                        <span><td>
          <!-- <a href="edit_student.php?id=<?php echo $row['id'];?>" ><span class="btn btn-outline-info btn-sm" style="">Edit</span></a> -->
                         
                        
             <a href="user-record.php?delete=<?php echo $row['id'];?>" onClick="return deldata('<?php echo $row['fullname']; ?>');"><span class="btn btn-outline-danger btn-sm" style=" margin-top: 4px;">delete</span></a>
